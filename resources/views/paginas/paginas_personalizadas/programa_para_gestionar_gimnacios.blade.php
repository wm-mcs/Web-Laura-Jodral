...
{{--*/ $ImagenPortada         = url() . '/imagenes/PaginasPersonalizadas/Socios/programa-para-gestionar-socios-online-en-la-nube.jpg'/*--}}
...
{{--*/ $Titulo                = 'Bienvenido a una nueva forma de administrar tu gimnasio' /*--}}
{{--*/ $DescriptionEtiqueta   = 'Si tienes una gimnacio y quieres un sistema que te ayude a administrar tu negocio, estás en el lugar correcto porque te voy a contar de qué trata EasySocio' /*--}}
{{--*/ $PalabrasClaves        = '' /*--}}
          ...
          <div class="col-md-12 mt-lg-5 text-left align-self-center text-intro">
            <div class="row">
              <div class="col-lg-8">
                ...
                <p class="text-secondary"> Software simple de usar para gestionar tu gimnasio, centro de fitness, box de crossfit o entrenamiento funcional </p>
