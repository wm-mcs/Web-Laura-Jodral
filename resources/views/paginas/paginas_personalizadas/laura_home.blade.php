          ...
          <div class="col-md-12 mt-lg-5 text-left align-self-center text-intro">
            <div class="row">
              <div class="col-8 col-lg-6 p-4 background-black-transparent" >
                <h1  class="titulos-class text-white font-primary mb-3">Di si! a la vida</h1>
      ...
      <div class="container ">
        <div class="row d-flex flex-row align-items-center justify-content-center">
          ...
          <div class="col-12  col-lg-6 p-2 p-lg-4 mt-3 mt-lg-0 " >
            <img class="img-fluid" data-src="{{url()}}/imagenes/Home/laura_jodral_vive_la_vida_que_amas.jpg">
