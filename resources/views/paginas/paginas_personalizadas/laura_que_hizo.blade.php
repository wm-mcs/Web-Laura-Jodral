...
{{--*/ $ImagenPortada         = url() . '/imagenes/Trayectoria/Trayectoria-laura.jpg'/*--}}
...
@section('portada')
    ...
    <div class="site-blocks-cover overlay bg-light" id="home-section">
      <div class="container">
       ...
       <img v-if="mostrar_para_celuar" class="imagen-portada-altura-100vh" style="position: absolute;top: 0;" data-src="{{$ImagenPortada}}" alt="Laura Jodral portada."> 
