<div  class="site-section background_img img_contacto-home " id="contacto_home">
  <div class="container">
    <div class="row align-items-center justify-content-center justify-content-lg-start">
      <div class="col-lg-6">
        <p class="color-text-white parrafo-class mb-2">Para contactarte rellenar el formulario de aqui abajo <i class="fas fa-hand-point-down"></i></p>
        <h3 class="titulos-class color-text-white mb-4">Contáctate ahora</h3>
